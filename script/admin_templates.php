                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <a class="service_link service_link_faucethub" target="_blank" href="https://faucethub.io/r/13852">FaucetHub.io (will close on 10 December 2019)</a>
                            <a class="service_link service_link_expresscrypto" target="_blank" href="https://expresscrypto.io/signup?referral=2465">ExpressCrypto.io</a>
                            <a class="service_link service_link_cedsonhub" target="_blank" href="https://cedsonhub.site/referral?r=MakeJar">CedsonHub.site</a>
                            <a class="service_link service_link_kswallet" target="_blank" href="https://www.kswallet.net/register?r=makejar.com">ksWallet.net</a>
                            <a class="service_link service_link_cryptoome" target="_blank" href="https://cryptoo.me/register/">Cryptoo.me</a>
                        ...
                        <div class="form-group service_field service_field_expresscrypto">
                            <label for="usertoken" class="control-label">User Token</label>
                            <input type="text" class="form-control" name="usertoken" value="<:: usertoken ::>">
                        </div>
                        <div class="form-group service_field service_field_kswallet">
                            <label for="kswallet_meta_id" class="control-label">ksWallet meta ID</label>
                            <input type="text" class="form-control" name="kswallet_meta_id" value="<:: kswallet_meta_id ::>">
                        </div>
                    </div>
                </div>
                <div class="row">
