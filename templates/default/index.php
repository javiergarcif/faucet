    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xs-12 col-md-6 col-md-push-3 <?php echo $data["custom_main_box_bg"] . ' ' . $data["custom_main_box_tx"]; ?>">
                ...
                <p class="alert alert-info">[<?php echo $data["currency"]; ?>] Balance: <?php echo $data["balance"]." ".$data["unit"]; ?></p>
                    ...
                    <form method="POST" class="form-horizontal" role="form">
                        ...
                        <div class="step2">
                            <div class="form-group">
                                ...
                                <input type="text" name="<?php echo $data["address_input_name"]; ?>" placeholder="i.e. <?php echo $data['address_placeholder']; ?>" class="form-control" value="<?php echo $data["address"]; ?>" />
                                </div>
                            </div>
                            <div class="form-group">
