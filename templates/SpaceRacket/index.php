    ...
    <div id="page-cols">
				<div class="page-col-body">
					...
					<div id="header">
                        ...
                        <div class="balance">[<?php echo $data["currency"]; ?>] Balance: <?php echo $data["balance"]." ".$data["unit"]; ?></div>
							...
							<form method="POST">
                                ...
                                <div class="step2">
                                    <div>
                                        ...
                                        <input type="text" name="<?php echo $data["address_input_name"]; ?>" class="main-input <?php if($data['custom_input_style']==1) echo 'normal'; ?>" placeholder="i.e. <?php echo $data['address_placeholder']; ?>" value="<?php echo $data["address"]; ?>" />
                                    </div>
                                    <div>
