...
'.
                    ...
                    */
                    ...
                    if (adminlog_claim_data[z][\'address_ref\']!=\'\') {
                        data_string+=\'<br />\'+adminlog_claim_data[z][\'address_ref\'];
                    }'.
                    /*
        ...
        if ($wfm_exist) {
            $adminlog_log.='
                ...
                data_string+=\'<td style="\'+al_row_css+\'"><b>\'+adminlog_claim_data[z][\'WFM_Log_suggestion\']+\'</b><br />\'+adminlog_claim_data[z][\'WFM_Log_reason\']+\'</td>\';
            ';
        }
        */
